...
Capabilities: **`sync-lifecycle`**, **`azure-platform`**, **`observability`**, **`integration-apis`**, **`snyk-issues-client`**, **`application-config`**. See **`SPEC.md`** for paths into `openspec/specs/`.
